...
from src.engine.actions.tactical_action import ActivateCommand, EndMovementCommand
from src.engine.core.command import CommandType
from src.engine.core.game_state import System, TacticalActionStep, GameState, Phase, TurnContext
...
def test_89_2_b_active_player_may_move_no_ships() -> None:
    ...
    new_state = session.apply_command(
        EndMovementCommand(actor=player_a, command_type=CommandType.END_MOVEMENT)
    )
